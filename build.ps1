...
try {
    ...
    & cl.exe /nologo /O2 /MT /W4 /utf-8 /EHsc WindowPin.cpp "/Fo:$outputDir\WindowPin.obj" "/Fe:$outputDir\WindowPin.exe" /link /SUBSYSTEM:WINDOWS "$outputDir\WindowPin.res" user32.lib shell32.lib advapi32.lib
